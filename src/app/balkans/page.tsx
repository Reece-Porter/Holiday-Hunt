...
const pricingItems = [
  ...
  { label: "Food & drink", amount: "£175", note: "Extremely affordable — meals from £3–8. Bosnia & Albania cheapest." },
  { label: "Activities", amount: "£80", note: "City walls, museums, fortress climbs, day trips" },
];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-24 space-y-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            { icon: <PoundSterling className="h-5 w-5" />, label: "From per person", value: "~£840" },
        ...
        <div>
          ...
          <PricingTable items={pricingItems} total="~£841pp" duration="14 nights" accentColor="violet" />
